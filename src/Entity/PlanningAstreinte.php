...
class PlanningAstreinte
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Astreignable", inversedBy="plannings")
    ...
    public function setDateDebut(\DateTimeInterface $date): self { $this->dateDebut = $date; return $this; }
    public function getDateFin(): ?\DateTimeInterface { return $this->dateFin; }
    public function setDateFin(\DateTimeInterface $date): self { $this->dateFin = $date; return $this; }
    public function getTheme(): ?string { return $this->theme; }
    public function setTheme(string $theme): self { $this->theme = $theme; return $this; }
    public function getStatut(): ?string { return $this->statut; }
    public function setStatut(string $statut): self { $this->statut = $statut; return $this; }
    public function getBinome(): Collection { return $this->binome; }
    public function addBinome(Astreignable $a): self { if (!$this->binome->contains($a)) $this->binome[] = $a; return $this; }
    public function removeBinome(Astreignable $a): self { $this->binome->removeElement($a); return $this; }
}
